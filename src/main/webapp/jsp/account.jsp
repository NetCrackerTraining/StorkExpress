                        ...
                        <button class="navbar-toggler pull-xs-right hidden-md-up" type="button" data-toggle="collapse"
                            ...
                            <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm"
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu"
                                        ...
                                        <li class="nav-link link" style="margin: 0.5rem;"><a
                                                href="${pageContext.request.contextPath}/jsp/userStatistic.jsp">USERS</a>
                                        </li>
                                        <li class="nav-link link" style="margin: 0.5rem;"><a
                                ...
                                <c:when test="${user.isAdmin()}">
                                    ...
                                    <li class="nav-item"><a class="nav-link link"
                                                            href="${pageContext.request.contextPath}/ShowUsers">USERS</a>
                                    </li>
                                ...
                                <c:when test="${user.isSimpleUser()}">
                                    <li class="nav-item"><a class="nav-link link"
                                                            href="${pageContext.request.contextPath}/UserOrders">MY HISTORY</a>
                                    </li>
